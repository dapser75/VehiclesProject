...
public class Car extends Vehicle {
	...
	public void addTwoWheels(List<Wheel> wheels) throws Exception {
		if (wheels.size() != 2) {
			System.out.println("\nERROR: Un coche debe tener 2 ruedas por eje. FIN DEL PRIOGRAMA");
		...
		if (!rightWheel.equals(rightWheel, leftWheel)) {
			System.out.println("\nERROR: Las ruedas del mismo eje son diferentes. FIN DEL PRIOGRAMA");
			throw new Exception();
		}
	...
	/*ORIGINAL codigo de pruebas by dapser75
	public void addWheels(List<Wheel> frontWheels, List<Wheel> backWheels) throws Exception {
		addTwoWheels(frontWheels);
		addTwoWheels(backWheels);
	}
